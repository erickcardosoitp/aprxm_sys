...
import { TrendDown, PiggyBank, Warning, WarningCircle } from '@phosphor-icons/react'
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatTile
          ...
          hint={`${data.qtd_inadimplentes} mensalidades em aberto · recuperação: ${data.recuperacao.taxa_recuperacao_pct ?? '—'}%`}
          badge="agora"
