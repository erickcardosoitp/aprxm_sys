...
import {
  AlertTriangle, CheckCircle, DollarSign, Lock, MinusCircle,
      ...
      <div className="rounded-2xl border border-green-200 bg-white shadow-sm overflow-hidden">
        ...
        <div className="p-5 flex flex-col gap-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white py-3 rounded-xl font-semibold text-sm transition"
          >
