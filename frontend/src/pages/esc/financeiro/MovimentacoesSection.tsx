...
export default function MovimentacoesSection() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {detalhe && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" role="dialog" aria-modal="true" aria-labelledby="movimentacao-detalhe-title">
          <div className="w-full max-w-sm bg-white shadow-2xl border" style={{ borderColor: BORDER }}>
            <div className="flex items-center justify-between px-5 py-3 border-b" style={{ borderColor: BORDER }}>
              <h2 id="movimentacao-detalhe-title" className="text-sm font-semibold text-slate-800">Movimentação</h2>
