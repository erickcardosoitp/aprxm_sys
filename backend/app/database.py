...
async def init_db() -> None:
    ...
    from app.models import association, user, resident, finance, package, service_order, bank_statement, settings, mensalidade, empresa, provisioning_run, painel_admin  # noqa: F401
